...
python SepReformer_inference_time.py hparams/DAC_large_L4nq.yaml  --data_folder=$SLURM_TMPDIR/WSJ0Mix/wsj0-2mix-8k-min/wsj0-mix/2speakers

cd $HOME/projects/def-ravanelm/salmanhu/speechbrain/recipes/WSJ0Mix/separation
python Sep_Re_inference_time.py hparams/S4M-medium.yaml  --data_folder=$SLURM_TMPDIR/WSJ0Mix/wsj0-2mix-8k-min/wsj0-mix/2speakers
